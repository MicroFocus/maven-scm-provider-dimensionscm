...
public class DimensionsUpdateCmd extends AbstractUpdateCommand {
    ...
    private UpdateScmResult internalExecute(DimensionsScmProviderRepository repository, ScmFileSet scmFileSet) throws ScmException, TransformerException, ParserConfigurationException, IOException {
        ...
        return new UpdateScmResult("", ok ? DimensionsConstants.COMMAND_SUCCEEDED : DimensionsConstants.COMMAND_FAILED, "UPDATE completed", ok);
    }

    @Override
    protected UpdateScmResult executeUpdateCommand(ScmProviderRepository repository, ScmFileSet scmFileSet, ScmVersion scmVersion) {
        try {

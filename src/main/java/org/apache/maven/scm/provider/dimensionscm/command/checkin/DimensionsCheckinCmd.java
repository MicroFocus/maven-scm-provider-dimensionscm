...
public class DimensionsCheckinCmd extends AbstractCheckInCommand {
    ...
    private CheckInScmResult internalExecute(DimensionsScmProviderRepository repository, ScmFileSet scmFileSet, String message) throws ScmException, TransformerException, ParserConfigurationException {
        ...
        return new CheckInScmResult("", ok ? DimensionsConstants.COMMAND_SUCCEEDED : DimensionsConstants.COMMAND_FAILED, "CHECKIN completed", ok);
    }

    @Override
    protected CheckInScmResult executeCheckInCommand(ScmProviderRepository repository, ScmFileSet scmFileSet, String message, ScmVersion scmVersion) {
        try {

...
public class ParameterUtil {
    ...
    /**
     * System property (boolean value) for enabling or disabling whether all foreign content is allowed to be delivered to a stream.
     */
    ...
    /**
     * System property for passing a project/stream relative location through to a dimensions command.
     */
    private static final String SYSTEM_RELATIVE_LOCATION = "dimensionscm.relativeLocation";

    /**
     * System property for passing a request or a comma separated request list through to a dimensions command.
     */
    ...
    /**
     * System property for passing user defined attributes (in json format) through to a dimensions command.
     */
    private static final String SYSTEM_ATTRIBUTES = "dimensionscm.attributes";

    /**
     * System property for passing user defined attributes (in org.json format) through to a dimensions command.
     */

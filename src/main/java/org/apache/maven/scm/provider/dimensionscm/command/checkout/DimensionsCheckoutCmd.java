...
public class DimensionsCheckoutCmd extends AbstractCheckOutCommand {
    ...
    private CheckOutScmResult internalExecute(DimensionsScmProviderRepository repository, ScmFileSet fileSet, boolean recursive) throws ScmException, TransformerException, ParserConfigurationException, IOException {
        ...
        return new CheckOutScmResult("", ok ? DimensionsConstants.COMMAND_SUCCEEDED : DimensionsConstants.COMMAND_FAILED, "CHECKOUT completed", ok);
    }

    @Override
    protected CheckOutScmResult executeCheckOutCommand(ScmProviderRepository repository, ScmFileSet fileSet, ScmVersion scmVersion, boolean recursive, boolean shallow) throws ScmException {
        try {
